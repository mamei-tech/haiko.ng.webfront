...
import CmpCardStats from '@/components/cards/CmpCardStats.vue'
...
import CmpTablePicture from '@/components/table/CmpDataTable.vue'
import CmpTableColor from '@/components/table/CmpTableColor.vue'
